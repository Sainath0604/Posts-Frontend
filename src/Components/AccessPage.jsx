...
const AccessPage = () => {
  return (
    <div className="w-full p-10 md:p-20 ">
      <div className=" border border-[#001C30] rounded-lg bg-[#EAFDFC] p-10 md:p-20">
        <div className="flex flex-col">
          ...
          <Link className="flex items-center justify-center" to="/signIn">
            <button className="flex items-center justify-center border border-[#001C30] p-2 rounded-xl bg-[#176B87] text-white md:h-14 md:p-5 md:text-xl md:font-semibold">
              Log-in
            </button>
          </Link>
        </div>
